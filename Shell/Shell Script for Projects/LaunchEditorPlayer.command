...
$EDITOR $CUR_FOLDER/$PROJECT.uproject -game ResX=800 ResY=600 -NoVSync -WINDOWED DISABLEALLSCREENMESSAGES $1 -FPS=30 ?DEBUG_UI1 -AbsLog=$CUR_FOLDER/Log/EditorPlayer.log
