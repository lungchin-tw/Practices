...
const char * CreatePath(const char* filename, enum DirectoryType argument) {
	...
	*/
	...
	printf("builddir is   <.>\n");
	printf("abs_srcdir is </Users/Ilipton/Documents/Practice/MakeTarBall/ntp-4.2.8p3/sntp/tests>\n");
	strcpy(path,"/Users/Ilipton/Documents/Practice/MakeTarBall/ntp-4.2.8p3/sntp/tests/data/");
